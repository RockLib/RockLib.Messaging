...
namespace RockLib.Messaging.CloudEvents
{
    ...
    public class CloudEventValidationException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CloudEventValidationException"/> class with serialized data.
        /// </summary>
        /// <param name="info">
        ...
        /// </param>
        protected CloudEventValidationException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }
}
