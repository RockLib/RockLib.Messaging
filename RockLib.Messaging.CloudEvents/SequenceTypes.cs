...
{
    /// <summary>
    /// Defines values for the <see cref="SequenceEvent.SequenceType"/> attribute.
    /// </summary>
    public static class SequenceTypes
    {
        /// <summary>
        /// If the <see cref="SequenceEvent.SequenceType"/> attribute is set to <c>"Integer"</c>,
        /// the <see cref="SequenceEvent.Sequence"/> attribute has the following semantics:
        /// <list type="bullet">
